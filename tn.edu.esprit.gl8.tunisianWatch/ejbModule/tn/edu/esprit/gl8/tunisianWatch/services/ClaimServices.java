...
public class ClaimServices implements ClaimServicesLocal {
	...
	@Override
	public boolean addClaim(String location, String priority,
			String description, String direction, String statut, String date) {
		boolean b = false;
		try {
			entityManager.persist(new Claim(description, location, direction,
					statut, priority, date));
			b = true;
