...
public interface ClaimServicesLocal {
	...
	public boolean addClaim(@PathParam(value = "location") String location,
			@PathParam(value = "priority") String priority,
			@PathParam(value = "description") String description,
			@PathParam(value = "direction") String direction,
			@PathParam(value = "statut") String statut,
	...
	@javax.ws.rs.Produces(MediaType.APPLICATION_JSON)
	public List<Claim> getClaimsByMC(@PathParam(value = "motCle") String mC);
}
